...
public class NonStaticGlobalVariableExample2 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * After each instance/object creation a copy of non-static member(variable+method) will be loaded into the newly
		 * created object memory
		 * 
		 * A change made in once instance/object won;t impact another object/instance.
		 */
		...
		System.out.println("After initialization, NSGV num1 with ref1 object: "+ref1.num1);//20
		System.out.println("After initialization, NSGV num2 with ref1 object: "+ref1.num2);//50
		System.out.println("Result: "+result);
		
		NonStaticGlobalVariableExample2 ref2=new NonStaticGlobalVariableExample2();
		System.out.println("NSGV num1 with ref2 object: "+ref2.num1);
		System.out.println("NSGV num2 with ref2 object: "+ref2.num2);
