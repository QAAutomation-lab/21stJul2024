...
public class StaticGlobalVariableExample2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("SGV num1: "+StaticGlobalVariableExample2.num1);//0
		System.out.println("SGV num1: "+StaticGlobalVariableExample2.num2);//0
		int result;
		StaticGlobalVariableExample2.num1=25;
		StaticGlobalVariableExample2.num2=45;
		result=StaticGlobalVariableExample2.num1+StaticGlobalVariableExample2.num2;
		System.out.println("After initialization,SGV num1: "+StaticGlobalVariableExample2.num1);//25
		System.out.println("After initialization,SGV num1: "+StaticGlobalVariableExample2.num2);//45
		System.out.println("Result: "+result);
		
		num1=101;
		num2=199;
		result=num2-num1;
		System.out.println("After initialization,SGV num1: "+StaticGlobalVariableExample2.num1);//101
		System.out.println("After initialization,SGV num1: "+StaticGlobalVariableExample2.num2);//199
		System.out.println("Result: "+result);
